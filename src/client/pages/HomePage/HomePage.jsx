...
export const HomePage = () => {
  ...
  return (
    <>
      ...
      <MyComponent
        classname={
          visibleLogo || visible || visible3
            ? 'preloader-small-logo'
            : 'preloader-big-logo'
        }
      />
        ...
        <div className="children-content">
          ...
          <div className="container1 d-flex justify-content-between">
            <container className="row-wrapper mb-0 p-0">
              <aside className="left-menu first-pre-benefits-block first-pre-benefits-block-85">
                ...
                <div className="d-flex justify-content-center mt-1 ml-2  p-5 align-items-center react-player-block">
                  <ReactPlayer
                    controls
                    width="100%"
                    url="https://youtu.be/F_MxQ16INXk"
                  />
                </div>
                <div />
              </aside>
            ...
            <container className="row-wrapper mt-0 pt-2">
              <aside
                ref={ref2}
                className="left-menu img-block aside-w-65 carousel-block position-relative"
              >
                ...
                <div className="product-carousel-block pl-2 pr-2">
                  <ProductsCarousel sortBy="price" />
                </div>
                <div className="product-carousel-block-2 pl-2 pr-2">
                  <ProductsCarousel sortBy="quantity" />
                </div>
              </aside>
              <main className="main-content calc-parent-container pr-2">
                ...
                <div
                  ref={refLogo}
                  className={'block1__small__container__right'}
                />
            ...
            <container className="row-wrapper">
              <aside ref={ref3} className="left-menu">
                ...
                <div className={'block1__container'}>
                  <div className={'block1__small__container__right'}>
                    <h1 className={'block__1__header'}>
                      Найчастіші запитання:
                    </h1>
                    <div className={'block__1__text'}>
                      {' '}
                      Скільки днів вирощуються кури
                    </div>
                  </div>
                </div>
                <div className={'block1__container'}>
                  <div className={'block1__small__container__right'}>
                    {/*<h1 className={"block__1__header"}>Почніть зі здоров’я</h1>*/}
                    <div className={'block__1__text'}> Який раціон курей</div>
                  </div>
                </div>
                <div className={'block1__container'}>
                  <div className={'block1__small__container__right'}>
                    ...
                    <div className={'block__1__text'}>
                      {' '}
                      Які медикаменти застосовуються
                    </div>
                  </div>
                </div>
              ...
              <main className="main-content pr-2 pb-2">
                ...
                <MagicCard
                  classname={
                    visibleCard ? 'magic-card-container pb-2 pl-2' : 'invisible'
                  }
                  imgLink={food}
                  height="100%"
                  width="100%"
            ...
            <container className="row-wrapper">
              <aside
                ref={ref}
                className={visible ? 'left-menu active' : 'left-menu'}
              >
                ...
                <div className={'block1__container'}>
                  <div className={'block1__small__container__left'}>
                    <h3 className={'block__1__header'}>
                      Виробництво ТМ “Епікур”
                    </h3>
                    <div className={'block__1__text'}>
                      {' '}
                      Виробництво ТМ “Епікур” — це просторі пташники й доглянуті
                      курочки, що зростають на натуральних рослинних кормах і
                      чистій воді. Це свіже волинське повітря й перевірені
                      європейські технології, що допомагають виробляти ніжне та
                      якісне куряче м’ясо без використання стимуляторів росту та
                      антибіотиків для профілактики. Все це для того, щоб наші
                      покупці справді відчували себе здоровими. У виробництві
                      курятини Епікур, антибіотики – відсутні на всіх етапах. Це
                      підтверджують регулярні аналізи в державних профільних
                      лабораторіях на 10-й, 20-й, 30-й та 42-й день вирощування
                      курки , та додаткові лабораторні дослідження курятини
                      перед пакуванням.
                    </div>
                  </div>
                </div>
              ...
              <main className="main-content">
                ...
                <div className={'block1__container'}>
                  <div className={'block1__small__container__right'}>
                    <h3 className={'block__1__header'}>
                      Переваги курятини ТМ Епікур”
                    </h3>
                    <div className={'block__1__text'}>
                      {' '}
                      Продукція ТМ” Епікур” - це більше ніж смачна й корисна
                      курочка без антибіотиків та інших стимуляторів росту. Вона
                      покликана допомагати кожній людині вести здорове та
                      щасливе життя й будувати його для близьких. Ми мріємо про
                      щасливе суспільство, що вміє радіти дрібницям й цінувати
                      кожну мить. І наша курочка в досягнення цієї мети стає
                      важливим інгредієнтом збалансованої дієти — це маленький,
                      але важливий крок до життя, сповненого енергії, перемог та
                      вдосконалень.
                    </div>
                  </div>
                </div>
          ...
          <div ref={ref4} className="position-relative h-100 footer-block">
            <div
              className={
                visible4
                  ? 'map-parent-block-visible map-parent-block h-100'
                  : 'map-parent-block'
              }
            >
              <EpikurGoogleMaps />
            ...
            <div
              className={
                visible4
                  ? 'contacts-parent-block-visible h-100 contacts-parent-block'
                  : 'contacts-parent-block'
              }
            >
              <Contacts />
            </div>
